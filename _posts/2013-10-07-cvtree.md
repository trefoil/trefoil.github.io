...
$$p(a_2 a_3 \cdots a_K \vert a_2 a_3 a_{K-1}) = p(a_1 a_2 \cdots a_K \vert a_1 a_2 a_{K-1})$$.

上式展开整理后，我们可以估计$$K$$这一步时的概率：

$$p^0 (a_1 a_2 \cdots a_K) = \frac{p(a_1 a_2 a_{K-1}) p(a_2 a_3 a_{K-1})}{p(a_1 a_2 \cdots a_K)}$$.
